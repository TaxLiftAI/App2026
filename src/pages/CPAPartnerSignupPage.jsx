...
function calc(clients, plan = 299) {
  const monthly = Math.round(clients * plan * 0.15)
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-white flex items-center justify-center px-4 py-16">
      <div className="max-w-lg w-full text-center">
        ...
        <p className="text-gray-500 mb-8">
          ...
          to start earning 15% commission on every subscription.
        </p>
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-5xl mx-auto px-6 pt-16 pb-12 text-center">
        <div className="inline-flex items-center gap-2 bg-indigo-50 border border-indigo-100 rounded-full px-4 py-1.5 text-xs font-semibold text-indigo-700 mb-6">
          <Star size={12} />
          Earn 15% recurring commission — no cap, no expiry
        </div>
        <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 leading-tight mb-4">
          Refer clients to TaxLift.<br />
          <span className="text-indigo-600">Earn every month they stay.</span>
        </h1>
        <p className="text-lg text-gray-500 max-w-2xl mx-auto mb-10">
          TaxLift automates SR&ED documentation for your software clients — saving 40+ hours of back-and-forth
          and generating CPA-ready T661 packages. You refer, they subscribe, you earn.
        </p>

        {/* Stats */}
        <div className="grid grid-cols-3 gap-8 max-w-xl mx-auto mb-12">
          <Stat value="15%" label="recurring commission" />
        ...
        <div>
          ...
          <div className="space-y-5 mb-10">
            {[
              ...
              {
                icon: DollarSign,
                title: 'You earn 15% of every subscription payment',
                body: 'Starter ($299/mo) or Plus ($599/mo). Commissions are paid monthly via e-Transfer. No minimum clients, no expiry date.',
              },
              {
                icon: Shield,
          ...
          <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-6">
            ...
            <div className="flex items-center gap-4 mb-4">
              <label className="text-sm text-gray-600 whitespace-nowrap">Clients referred:</label>
              <input
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white rounded-lg p-4 text-center border border-indigo-100">
                <p className="text-2xl font-extrabold text-indigo-700">
                  ${commission.monthly.toLocaleString('en-CA')}
                </p>
                <p className="text-xs text-gray-500 mt-1">per month</p>
              </div>
              <div className="bg-white rounded-lg p-4 text-center border border-indigo-100">
                <p className="text-2xl font-extrabold text-gray-900">
                  ${commission.annual.toLocaleString('en-CA')}
                </p>
                <p className="text-xs text-gray-500 mt-1">per year</p>
              </div>
            </div>
            <p className="text-xs text-gray-400 mt-3 text-center">
              Based on Starter plan ($299/mo) × 15% commission
            </p>
          </div>
        </div>
      ...
      <section className="bg-gray-50 border-t border-gray-100 py-16 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ['When do I get paid?', 'Monthly, by the 15th of the following month. We use e-Transfer for Canadian partners or wire transfer for international.'],
              ['Is there a minimum number of referrals?', 'No minimum. Even one referral earns you 15% of their subscription for as long as they remain a customer.'],
