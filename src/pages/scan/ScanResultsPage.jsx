  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
        ...
        {/* ── Activity Log nudge ────────────────────────────────────────────── */}
        <div className="bg-violet-50 border border-violet-200 rounded-2xl p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">
              ...
              security work — none of which appear in commit history. Download our Activity Log
              template, log those hours, and upload for a complete estimate. Most teams see{' '}
