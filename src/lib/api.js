...
// ── Auth ──────────────────────────────────────────────────────────────────────
  export const auth = {
      ...
      /** Get the company profile (province, industry_domain, employee_count, etc.) */
      getProfile: () => get('/api/auth/profile'),
    
      /** Update company profile — also busts the eligibility cache server-side */
      updateProfile: (payload) =>
            request('PATCH', '/api/auth/profile', { body: payload }),
  }
